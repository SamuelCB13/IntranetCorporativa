...
export default function Carousel() {
    ...
    const images = [
        '/background.webp',
        '/logofinal.webp',
        '/logofinal-blanco.webp',
        '/anota-gol-y-gana.jpg',
        '/background.webp'
    ];
    ...
    const goToSlide = (index: number) => {
        ...
        // Reanudar auto-reproducción después de 5 segundos
    ...
    return (
        <div className="relative w-full max-w-4xl mx-auto">
            ...
            >
                <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 group-hover:bg-white/50 transition-all duration-300 group-focus:ring-4 group-focus:ring-white/70 group-focus:outline-none">
                    <ChevronLeftIcon />
                </span>
            </button>
            ...
            <div className="absolute top-4 right-4 z-40">
                ...
                >
                    {isAutoPlaying ? (
                        <CirclePauseIcon className='size-5 text-blue-400' />
                    ) : (
                        <CirclePlayIcon className='size-5 text-blue-400' />
                    )}
                </button>
            </div>

            {/* Contador de slides */}
            <div className="absolute top-4 left-4 z-40 bg-neutral-800 text-blue-400 px-3 py-1 rounded-full text-sm">
