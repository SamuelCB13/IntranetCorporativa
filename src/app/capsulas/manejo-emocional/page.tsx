                ...
                <section className="w-full flex flex-col gap-6 sm:gap-8 lg:gap-10">
                    <header className="flex flex-col gap-3 sm:gap-4 border border-neutral-600 rounded-xl p-4 sm:p-6 lg:p-8">
                        ...
                        <p className="text-sm sm:text-base font-bold text-neutral-400 leading-relaxed">
                            Las emociones forman parte esencial de la experiencia humana. Alegría, tristeza, enojo, miedo o sorpresa son respuestas naturales ante lo que vivimos día a día. Sin embargo, lo que realmente marca la diferencia en nuestro bienestar personal y nuestras relaciones no es lo que sentimos, sino cómo manejamos eso que sentimos.
                        </p>
                    </header>
